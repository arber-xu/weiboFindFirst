...
public class Timeline extends Weibo{
	...
	public StatusWapper getUserTimelineByName(String screen_name,int pageNum) throws WeiboException {
		return Status.constructWapperStatus(client.get(WeiboConfig
				.getValue("baseURL") + "statuses/user_timeline.json",new PostParameter[]{
			new PostParameter("screen_name", screen_name),new PostParameter("count", 200),new PostParameter("page", pageNum)
		}));
	}
	/**
	 * 获取某个用户最新发表的微博列表
